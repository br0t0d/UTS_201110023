    ...
    <div class="container mt-5">
        ...
        <form method="POST" action="hasil.php">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" name="g1" value="1">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" name="g2" value="1">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" name="g3" value="1">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" name="g4" value="1">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" name="g5" value="1">
                            </div>
                        </td>
                    </tr>
                </tbody>
            ...
            <div style="width: 500px; margin: auto;">
                <button class="button_login" style="width: 100%; padding: 10px;">Lihat Hasil</button>
            </div>
        </form>
